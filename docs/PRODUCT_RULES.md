...
- **ADS-12** At most one a day, counted by the device's own day, and none until ten transactions have been recorded. The count is the whole of the test: someone with ten entries behind them is using the app, and someone with fewer is still looking at it.
