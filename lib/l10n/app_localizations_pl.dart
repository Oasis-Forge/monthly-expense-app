...
class AppLocalizationsPl extends AppLocalizations {
  ...
  @override
  String get accountsTotalLabel => 'Suma';
  ...
  String homeSpentPerDay(String amount, String perDay) {
    return 'Wydano $amount · $perDay dziennie jak dotąd';
  }

  @override
  String get homeSetBudget => 'Ustaw budżet miesięczny';
  ...
  String billsPerMonth(String amount) {
    return '$amount miesięcznie na rachunki';
  }

  @override
  String nextBillToday(String title) {
    return 'Następny: $title, dziś';
  }

  @override
  String nextBillTomorrow(String title) {
    return 'Następny: $title, jutro';
  }
  ...
  String nextBill(int days, String title) {
    String _temp0 = intl.Intl.pluralLogic(
      days,
      locale: localeName,
      other: 'Następny: $title, za $days dni',
      many: 'Następny: $title, za $days dni',
      few: 'Następny: $title, za $days dni',
      one: 'Następny: $title, za $days dzień',
    );
    return '$_temp0';
  }
  ...
  String get recurringEmptyMessage =>
      'Cykliczne transakcje księgują czynsz, wypłatę lub subskrypcję według ustalonego przez ciebie harmonogramu i czekają na dotknięcie, by potwierdzić każdą z nich.';

  @override
  String get addRecurringButton => 'Dodaj cykliczną transakcję';
  ...
  String get trendNeedsMorePeriods =>
      'Trend wymaga więcej niż jednego okresu. Wróć w przyszłym miesiącu.';
  ...
  @override
  String get updateDownloadedMessage => 'Pobrano aktualizację.';

  @override
  String get updateRestartButton => 'Uruchom ponownie';
}
